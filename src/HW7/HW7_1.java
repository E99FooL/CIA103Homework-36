...
//		意物件寫入需注意的事項,若C:\內沒有data資料夾,請用程式新增這個資料夾
		HW7_Pet[] objs = new HW7_Pet[4];
		objs[0] = new HW7_CAT("Catty1");
		objs[1] = new HW7_CAT("Catty2");
		objs[2] = new HW7_DOG("Doggy1");

		objs[3] = new HW7_DOG("Doggy2");
...
//		型簡化本題的程式設計)
		...
		try {
			HW7_Pet[] objs2 = new HW7_Pet[4];
			for (int i = 0; i < objs2.length; i++) {
				objs2[i] = (HW7_Pet)ois.readObject();
				objs2[i].speak();
